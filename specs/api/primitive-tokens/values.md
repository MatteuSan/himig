---
title: Primitive Token Values
slug: /api/primitive-tokens/values
---
# Primitive Token Values
Listed below are valid values available for consumption using the `primitive-token-get` function.
